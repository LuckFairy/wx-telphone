...
Page({
    ...
    onLoad: function (options) {
        ...
        if (q) {
            ...
            try {
                ...
                console.log("-------------after parse locationId:" + qrData.locationId);
                ...
                console.log('has sign = ' + getApp().hasSignin);
                if (getApp().hasSignin) {
                    clearInterval(checkTimer);
    ...
    buildRedirctUrl: function () {
        ...
        if (resType == 'card') {//跳转到卡券领取页面
          ...
          console.log('go into groupbuy');
          console.log('prodId' + resId);
