...
Page({
  ...
  clickGoCategory(e) {
    ...
    wx.navigateTo({
      url: '../index-new/index-boabao?listld=' + index + '&catId=' + catId
    })
  },
 ...
 */
  ...
  clickGoBaoKuan: function (e) {
    ...
    wx.navigateTo({
      url: '../index-new/shop-list?categoryid=' + categoryid + '&page=' + page + '&store_id=' + store_id +'&title=爆款专区'
    })
  },
  //跳到热销商品页
  clickGoHotSale: function (e) {
    ...
    var { categoryid, page = "1" } = e.currentTarget.dataset;// 分类id , 分页码 ， 店铺id
    wx.navigateTo({
      url: '../index-new/shop-list?categoryid=' + categoryid + '&page=' + page + '&store_id=' + store_id + '&title=热销专区'
    })
  },
  //跳到百货商品页
  clickGoGoods: function (e) {
    ...
    var { categoryid, page = "1", } = e.currentTarget.dataset;// 分类id , 分页码 ， 店铺id
    wx.navigateTo({
      url: '../index-new/shop-list?categoryid=' + categoryid + '&page=' + page + '&store_id=' + store_id + '&title=百货专区'
    })
  },
  //跳到活动（节日）商品页
  clickGoFestival: function (e) {
    ...
    var { categoryid, page = "1" } = e.currentTarget.dataset;// 分类id , 分页码 ， 店铺id
    wx.navigateTo({
      url: '../index-new/shop-list?categoryid=' + categoryid + '&page=' + page + '&store_id=' + store_id + '&title=活动专区'
    })
  },
  //跳到热门推荐商品页
