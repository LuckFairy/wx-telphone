...
class WxService {
    ...
    __initTools() {
        this.tools = {
            ...
            // 处理url，如http://api.qutego.com?key=value
            buildUrl(url, obj) {
