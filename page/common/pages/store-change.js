  ...
  loadAddress(opt) {
    ...
    app.api.postApi("wxapp.php?c=order_v2&a=get_physical_list", { params }, (err, resp) => {
      ...
      if (params.position == 1) {
        if (provinces.length > 0) { this.setData({ itemList: provinces, provinFlag: true, cityFlag: true, cityId: null, city: '市' }) } else {
        ...
        if (area.length > 0) { this.setData({ itemList: area, areaFlag: true, areaId: null, area: '区' }) } else {
