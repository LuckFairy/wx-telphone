...
Page({
  ...
  onShareAppMessage(res) {
    var that=this,dataset=res.target.dataset;
    return { 
      title: dataset.title,
      path: '/page/common/pages/goods-detail?prodId=' + this.data.prodId
     }
  },
  ...
  doBuy: function () {
    ...
    if (action === 'present') {
      ...
      let url = "./present-apply?options=" + _params + '&prodId=' + prodId + '&skuid=' + skuId + '&groupbuyId=' + groupbuyId; //2017年8月17日17:18:09 by leo
      wx.redirectTo({ url });
    } else {  
      if (skuId) {
      } else {
      ...
      let url = '../../common/pages/buy?prodId=' + prodId + '&skuid=' + skuId + '&num=' + num + '&pskid=' + pskid;
      wx.navigateTo({ url });
    }
  },
  gotoCart: function () {
