  ...
  */
  onShareAppMessage(res) {
    ...
    // if (res.from === 'button') {
      ...
      var path = '/page/group-buying/group-join?prodId=' + prodId + '&groupbuyId=' + groupbuyId + '&groupbuyOrderId=' + groupbuyOrderId;
  ...
  doBuy: function () {
    ...
    let url = '../../common/pages/buy?prodId=' + prodId + '&groupbuyId=' + groupbuyId + '&groupbuyOrderId=0' + '&skuid=' + skuId + '&num=' + num;
    //return;
    wx.navigateTo({ url });
  }, 
